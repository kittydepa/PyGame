...
DISPLAYSURF = pygame.display.set_mode((400, 300)) # This returns as a pygame.surface object - will be explained later on in the book. Also, need to set these dimensions as a tuple, not just plain intergers. That's why there are two sets of ()
